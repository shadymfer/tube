...
const Home: NextPage = (props) => {
	return (
		<div>
			...
			<div className="bg-black pb-8 sm:pb-12 lg:pb-12 min-h-screen text-center align-center items-center flex flex-col">
				<div className="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
					<div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24">
						<div>
							{/* <div>
								<img className="h-14 w-auto" src="/images/tase1.png" alt="Shadies" />
							</div> */}
							<div className="mt-10">
								{/* <div>
									<a href="#" className="inline-flex space-x-4">
										...
										<a
											href="https://twitter.com/shadies_nft"
											target="_blank"
								...
								<div className="mt-12 sm:max-w-lg sm:w-full sm:flex text-center align-center items-center flex flex-col">
									<div>
										...
										<Link href="/transmuters">
											<button className="text-center block w-full rounded-none border border-transparent px-5 py-3 bg-amber-500 text-base font-medium text-white shadow hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:px-10 ease-in duration-150 transition-all">
												ENTER
											</button>
										</Link>
									</div>
								...
								<div className="mt-6">
									<div className="inline-flex items-center divide-x  divide-gray-300  text-sm text-gray-500 min-w-medium ">
										<div className="inline-flex items-center py-2 pr-5">
											...
											<img src="/images/solwyt.png" className="h-10 w-auto pl-2" />
										</div>
