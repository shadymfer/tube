									...
									<div className={`h-1/3 py-6 bg-white shadow-xl`}>
										<div className="px-4 sm:px-6">
											<div className="flex items-start justify-between">
												<Dialog.Title>
													<dt className="text-sm font-medium text-gray-500 truncate">Tube Recipe</dt>
															...
															<ul key={index} className="border-t border-gray-200  w-full flex py-3 items-center hover:opacity-60 duration-150 ease-in transition-all">
																...
																<div>
																	<div className="flex items-center">
																		<span
																			className={`text-xs inline-flex items-center px-2 py-0.5 rounded font-medium text-${getExecutionState(item.account.state).color}-800 bg-${getExecutionState(item.account.state).color
																				}-100 `}
																		>
